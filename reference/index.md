...
R helpers for qrt-style runtime YAML composition without depending on
the qrt CLI.

- [`quartoReadFrontmatter()`](https://averriK.github.io/NGR/reference/quartoYaml.md)
  [`quartoAsSequence()`](https://averriK.github.io/NGR/reference/quartoYaml.md)
  [`quartoHasBookManifest()`](https://averriK.github.io/NGR/reference/quartoYaml.md)
  ...
  [`quartoWriteYaml()`](https://averriK.github.io/NGR/reference/quartoYaml.md)
...
- [`hc_theme_538_gridlines()`](https://averriK.github.io/NGR/reference/hc_theme_538_gridlines.md)
  : Highcharter theme based on FiveThirtyEight (538) with enhanced
  gridlines
...
- [`export()`](https://averriK.github.io/NGR/reference/export.md) :
  Export Highcharts widget to PNG
