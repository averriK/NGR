...
"$rscript_path" --vanilla "$root_dir/install/cli/testPreflight.R" "$root_dir/install"
"$rscript_path" --vanilla "$root_dir/install/cli/testDependencies.R" "$root_dir/install"
