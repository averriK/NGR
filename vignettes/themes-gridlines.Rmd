...
vignette: >
  %\VignetteIndexEntry{Temas con líneas de grilla para escalas logarítmicas}
...
Los ejemplos de esta vignette son intencionalmente mínimos. Para ejemplos ejecutables, use la documentación de las funciones `hc_theme_*_gridlines()` y `buildPlot()`.
