...
vignette: >
  %\VignetteIndexEntry{Adding Web Fonts to Typewriter Functions}
...
## Overview
This document describes the process for adding new Google Fonts (or other web fonts) to the typewriter effect functions in the NGR package. The typewriter functions include:
...
- Rebuild package: `R CMD build . && R CMD INSTALL NGR_*.tar.gz`
- Restart R session
