...
| `oq/`, `gmsp/`, `data/`, `run/` | Project data and producer records, excluded from resource-source destinations, together with `manifest.json`, `hazard.json` and `newmark.json` |
