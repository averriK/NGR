...
- `ngr` instalado en /usr/local el 2026-09-18 13:59 -03 desde 36e7182 con árbol SUCIO: BUILD_INFO git_describe termina en -dirty, por lo que todo render con esta instalación sale «· DRAFT» (lib/R/resources.R:160-169, lib/R/quartoRenderStamp.R:44-56). Archivos instalados a nombre de averrik, directorios de root. Se corrige con la reinstalación sudo desde 399602a.
...
## Blocker
Lado del agente resuelto: install/ commiteado (399602a), sello dirty limitado a cli/install/lib (el archivo ajeno modificado ya no sella), ownership a root bajo sudo. Falta solo que el propietario reinstale: `cd /Users/averrik/Cloud/github/libraries/NGR && sudo bash install/install.sh`, archivando la salida en dev/SoT/cli-repair/. Detalle en NOTICE-C2-VERIFICATION-20260918.md.
